    ...
    <div class="w-full mt-[80px] mb-[40px] bg-white shadow-lg rounded-md py-6 md:px-10 px-4">
      ...
      <div class="mt-8 md:flex gap-6">
        <label
          ...
          <div cursor-pointer="mt-4 text-[17px]">Select video to upload</div>
          ...
          <input ref="file" @input="onChange" type="file" id="fileInput" hidden accept=".mp4" />
        </label>

        <div v-else class="md:mx-0 mx-auto mt-4 mb-16 md:mb-12 flex items-center justify-center w-full max-w-[260px] h-[540px]  p-3 rounded-2xl cursor-pointer relative">
          <div class="bg-black h-full w-full"></div>

          <img src="~/assets/images/mobile-case.png" class="absolute z-20 pointer-events-none" alt="">

          <img src="~/assets/images/tiktok-logo-white.png" width="90" class="absolute right-4 bottom-6 z-20" alt="">

          <video :src="fileDisplay" autoplay loop muted class="absolute rounded-xl object-cover z-10 p-[13px] w-full h-full"></video>
