    ...
    <div class="pt-[90px] 2xl:pl-[185px] lg:pl-[160px] lg:pr-0 pr-2 w-[calc(100%-90px)] max-w-[1800px] 2xl:mx-auto">
      <div class="flex w-[calc(100vw-230px)]">
        <img
            ...
            class="max-w-[120px] rounded-full" alt="">
        <div class="ml-5 w-full">
          ...
          <button
              v-else
              class="flex items-center rounded-md py-1.5 px-3.5 mt-3 text-[15px] text-white font-semibold bg-[#F02C56]">
            Follow
          </button>
        </div>
      </div>
      ...
      <div class="flex w-full items-center pt-4 border-b">
