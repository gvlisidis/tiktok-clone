<template>
  <div id="PostMain" class="flex border-b py-6">
    <div class="cursor-pointer">
      <img src="https://picsum.photos/id/8/300/320" class="rounded-full max-h-[60px]" width="60" alt="">
    </div>
    <div class="pl-3 w-full px-4">
      ...
      <div class="mt-2.5 flex">
        <div class="relative min-h-[400x] max-h-[580px] max-w-[260px] flex items-center bg-black rounded-xl cursor-pointer">
          <video ref="video" loop muted class="rounded-xl object-cover mx-auto h-full" src="/rain.mp4"></video>
          <img src="~/assets/images/tiktok-logo-white.png" width="90" class="absolute right-2 bottom-14" alt="">
        </div>
