<template>
  ...
  >
    <div
        :class="!uploadedImage ? 'h-[6550px]' : 'h-[580px]'"
      ...
      <div
        ...
        <div v-if="!uploadedImage">
          ...
          >
            <div class="font-semibold text-[15px] sm:mb-0 mb-1 text-gray-700 sm:text-left text-center">
              Profile photo
            </div>

            <div class="flex items-center justify-center sm:-mt-6">
              <label for="image" class="relative cursor-pointer">
                <img src="https://picsum.photos/id/8/300/320" width="95" class="rounded-full" alt="">
                <div
          ...
          <div
              id="UsernameSection"
              class="flex flex-col border-b sm:h-[118px] px-1.5 mt-1.5 py-2 w-full">
          ...
          >
            ...
            <div class="flex items-center justify-center sm:-mt-6">
              <div class="sm:w-[60%] w-full max-w-md">
                ...
                <div v-if="useBio" class="text-[11px] text-gray-500">{{ userBio.length }}/80</div>
              </div>
            </div>
          </div>
        </div>
